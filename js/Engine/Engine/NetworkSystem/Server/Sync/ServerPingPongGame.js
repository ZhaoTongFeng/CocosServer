...
var ServerStatusSyncGame_1 = __importDefault(require("./ServerStatusSyncGame"));
/**
 * 乒乓球游戏
 * 状态同步实现
 *
 ...
 * 帧结束，将数据包进行广播
 */
var ServerPingPongGame = /** @class */ (function (_super) {
    __extends(ServerPingPongGame, _super);
    function ServerPingPongGame() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ServerPingPongGame_1 = ServerPingPongGame;
    var ServerPingPongGame_1;
    ServerPingPongGame = ServerPingPongGame_1 = __decorate([
        XBase_1.xclass(ServerPingPongGame_1)
    ], ServerPingPongGame);
    return ServerPingPongGame;
}(ServerStatusSyncGame_1.default));
exports.default = ServerPingPongGame;
