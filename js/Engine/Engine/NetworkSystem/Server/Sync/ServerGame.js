...
var ServerGame = /** @class */ (function (_super) {
    ...
    ServerGame_1 = ServerGame;
    //0.注册回调
    ServerGame.prototype.init = function (ns) {
    ...
    //准备阶段
    ServerGame.prototype.prePlay = function () {
    };
    ServerGame.prototype.onPrePlay = function () {
    };
    //开始游戏
    ServerGame.prototype.startPlay = function () {
    };
    ServerGame.prototype.onoStart = function () {
    };
    //游戏运行时
    ServerGame.prototype.playing = function () {
    };
    //游戏结束时
    ServerGame.prototype.endPlay = function () {
    };
    ServerGame.prototype.onEndPlay = function () {
    };
    var ServerGame_1;
    ServerGame = ServerGame_1 = __decorate([
        XBase_1.xclass(ServerGame_1)
    ], ServerGame);
    return ServerGame;
}(Game_1.default));
