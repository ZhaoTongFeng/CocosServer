 ...
 * 游戏基类
 */
var GameSync = /** @class */ (function (_super) {
    __extends(GameSync, _super);
    function GameSync() {
    ...
    GameSync_1 = GameSync;
    //0.注册回调
    GameSync.prototype.init = function (ns) {
    ...
    //准备阶段
    GameSync.prototype.prePlay = function () {
    };
    GameSync.prototype.onPrePlay = function () {
    };
    //开始游戏
    GameSync.prototype.startPlay = function () {
    };
    GameSync.prototype.onoStart = function () {
    };
    //游戏运行时
    GameSync.prototype.playing = function () {
    };
    //游戏结束时
    GameSync.prototype.endPlay = function () {
    };
    GameSync.prototype.onEndPlay = function () {
    };
    var GameSync_1;
    GameSync = GameSync_1 = __decorate([
        XBase_1.xclass(GameSync_1)
    ], GameSync);
    return GameSync;
}(Manager_1.default));
exports.default = GameSync;
