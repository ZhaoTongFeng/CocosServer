...
import ServerStatusSyncGame from "./ServerStatusSyncGame";
import StatusSyncGame from "./ServerStatusSyncGame";
 ...
 * 帧结束，将数据包进行广播
 */
@xclass(ServerPingPongGame)
export default class ServerPingPongGame extends ServerStatusSyncGame {
