...
import GameManager from "../../Share/Sync/GameManager";
 ...
 */
@xclass(ClientGameManager)
export default class ClientGameManager extends GameManager {
    @xproperty(Map)
    gameMap: Map<string, Game> = new Map();

    //0.注册回调
    init(ns: ClientNetworkSystem) {
        super.init(ns);
